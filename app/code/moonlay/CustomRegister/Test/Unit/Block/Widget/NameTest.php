...
namespace Moonlay\CustomRegister\Test\Unit\Block\Widget;
...
class NameTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->_block = new \Moonlay\CustomRegister\Block\Widget\Name(
            $context,
            $addressHelper,
            $this->customerMetadata,
            $this->_options,
    ...
    public function test_showConfig()
    {
        $mockObject = $this->getMockBuilder(
            \Moonlay\CustomRegister\Block\Widget\Name::class
        )->disableOriginalConstructor()->getMock();

        $reflectionClass = new \ReflectionClass(\Moonlay\CustomRegister\Block\Widget\Name::class);

        $reflectionMethod = $reflectionClass->getMethod('_showConfig');
        $reflectionMethod->setAccessible(true);

        $result = $reflectionMethod->invoke($mockObject, 'any key');
     ...
     */
    public function testGetAttributeValidationClass($attrCode, $attrClass, $customAttrClass, $expectedValue)
    {
        $this->assertEquals($expectedValue, $this->_block->getAttributeValidationClass($customAttrClass));
    }

    public function getAttributeValidationClassDataProvider()
    {
        return [
            ['attr_code', 'Attribute_Class', null, null],
    ...
    public function testGetAttributeNullException()
    {
        $refClass = new \ReflectionClass(\Moonlay\CustomRegister\Block\Widget\Name::class);
        $getAttribute = $refClass->getMethod('_getAttribute');
        ...
        $this->assertNull(null, $getAttribute->invoke($this->_block, 'any attribut'));
    }
}
