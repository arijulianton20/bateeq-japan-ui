...
class NameTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->_block = new \Moonlay\CustomEditAccount\Block\Widget\Name(
            $context,
            $addressHelper,
            $this->customerMetadata,
            $this->_options,
    ...
    public function test_showConfig(){
        $mockObject = $this->getMockBuilder(
            \Moonlay\CustomEditAccount\Block\Widget\Name::class
        )->disableOriginalConstructor()->getMock();

        $reflectionClass = new \ReflectionClass(\Moonlay\CustomEditAccount\Block\Widget\Name::class);
    ...
    {
        $refClass = new \ReflectionClass(\Moonlay\CustomEditAccount\Block\Widget\Name::class);
